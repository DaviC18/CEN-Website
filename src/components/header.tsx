...
const Header = () => {
  ...
  return (
    <div className="fixed z-50 flex w-full items-center justify-between border-sidebar-foreground border-b-[0.5px] bg-background pt-2 pr-[2%] pb-2 pl-[2%] ">
      <div className="w-1/5">
        {/** biome-ignore lint/performance/noImgElement: necessery */}
        {/** biome-ignore assist/source/useSortedAttributes: necessery */}
        <a href="">
      ...
      <div className="flex w-1/5 justify-end items-center gap-4">
        <ModeToggle />
        <InteractiveHoverButton>Instituto</InteractiveHoverButton>
        {/* <Button className={themesClass}>
					<span className="mb-[1px]">Instituto</span> <MoveRight className="movearrowr" strokeWidth={3} size={2} />
				</Button> */}
      </div>
    </div>
  );
